...
export default function Menu() {
  return (
    <nav className="mt-0.5 mb-1">
        ...
        {({ isActive }) => (
          <div
            className={classNames(
              "p-3 rounded-full transition-colors inline-flex  item-center gap-5 group-hover:bg-[#eff3f41a]",
              { "font-bold": isActive }
            )}
          >
            {!isActive && (
              <svg viewBox="0 0 24 24" height={26.25} width={26.25}>
                <path
                  fill="#e7e9ea"
      ...
      <NavLink to="/notification" className="py-1 block group">
        {({ isActive }) => (
          <div
            className={classNames(
              "p-3 rounded-full transition-colors inline-flex  item-center gap-5 group-hover:bg-[#eff3f41a]",
